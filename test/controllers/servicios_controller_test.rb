...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post servicios_url, params: { servicio: { descripcion: @servicio.descripcion, precio: @servicio.precio, titulo: @servicio.titulo } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { descripcion: @servicio.descripcion, precio: @servicio.precio, titulo: @servicio.titulo } }

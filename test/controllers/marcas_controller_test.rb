...
class MarcasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marca" do
    assert_difference('Marca.count') do
      post marcas_url, params: { marca: { descripcion: @marca.descripcion, empresa: @marca.empresa } }
    end
  ...
  test "should update marca" do
    patch marca_url(@marca), params: { marca: { descripcion: @marca.descripcion, empresa: @marca.empresa } }

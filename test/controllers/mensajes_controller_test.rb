...
class MensajesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mensaje" do
    assert_difference('Mensaje.count') do
      post mensajes_url, params: { mensaje: { correo_electronico: @mensaje.correo_electronico, mensaje: @mensaje.mensaje, nombre_apellido: @mensaje.nombre_apellido, telefono: @mensaje.telefono } }
    end
  ...
  test "should update mensaje" do
    patch mensaje_url(@mensaje), params: { mensaje: { correo_electronico: @mensaje.correo_electronico, mensaje: @mensaje.mensaje, nombre_apellido: @mensaje.nombre_apellido, telefono: @mensaje.telefono } }
